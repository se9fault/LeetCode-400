...
(turning on if it's off or turning off if it's on). For the i-th round, you
...
Solution: See https://leetcode.com/problems/bulb-switcher/discuss/77104/Math-solution..
*/
